define(['_','angular', 'angular-mocks', 'alexApp', 'views/partials/words.jade', 'views/partials/lessonCreator.jade'], function (_) {
    ...
    describe("Words directive", function () {
        ...
        //given
        var WORDS = [
            {word: 'w1', translation: 't1', lessonId: 'l1', _id: 1},
            {word: 'w2', translation: 't2', lessonId: 'l2', _id: 2}
        ];
        ...
        beforeEach(module('alexApp', function ($provide) {
            ...
            $provide.value('Words', {
                add: function (word) {
                    return {
                        then: function (cbk) {
                            var response = {data: [_.extend(word, {_id: ID_OF_WORD_TO_BE_ADDED})]};
                            cbk(response);
                        }
                    };
                },
        ...
        it("should add a new word", function () {
            ...
            var expectedWord = _.extend(WORD_TO_BE_ADDED, {_id: ID_OF_WORD_TO_BE_ADDED});
